...
//
// Mango generates section 1 or section 3 man pages, if the source package is
//or is not main, respecitively.
//Information is extracted automatically from the package's comments and AST,
//unless overridden, with few exceptions.
//
// If the package is main, the default name of the man page is the name of the
//file that contains the main function. The options section is generated by use
//of the flag package and an optional comment above the main function, a line
//consisting solely of:
//	//Usage: %name %flags EXTRA-OPTIONS
//Mango ignores the "%name" and "%flag"/"%flags" part is optional but make
...
//a single, one-character argument in library documents.
//
